...
import com.example.customnavigationview.R
...
class MainActivity : AppCompatActivity() {
    ...
    get() = findViewById(R.id.mapView)
    private val tripProgressCard: CardView
    ...
    get() = findViewById(R.id.stop)
    private val maneuverView: MapboxManeuverView
    get() = findViewById(R.id.maneuverView)
    private val routeOverview: MapboxRouteOverviewButton
